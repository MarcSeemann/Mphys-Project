...
df = pd.read_hdf('E:\Manchester_Uni\Physics_Year_4\MphysProject\Hecker\Calibration\other_test.h5', key='mydata')
...
for i in range(total_n_events):
    ...
    # adc_values_photo_peak_arr.append(np.sum(y_arr[i][starting_index_bin_0[i]:ending_index_bin_0[i]]))
